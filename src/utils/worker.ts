...
import type { WebSocketShardDestroyOptions, WorkerData, WorkerSendPayload } from "@discordjs/ws";
import {
	WebSocketShard,
...
import type { WorkerReceivePayload } from "../strategies/IndomitableWorkerShardingStrategy.js";
import { WorkerReceivePayloadOp } from "../strategies/IndomitableWorkerShardingStrategy.js";
					...
					case WorkerSendPayloadOp.FetchStatus: {
						...
						const response: WorkerReceivePayload = {
							...
							status: {
								...
								lastHeartbeatAt: shard["lastHeartbeatAt"],
								// eslint-disable-next-line @typescript-eslint/dot-notation
								sendQueueRemaining: shard["sendQueue"].remaining,
							},
							nonce: payload.nonce,
						};
